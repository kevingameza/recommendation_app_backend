...
def obtener_recomendaciones(
    ...
    db_recomendation = models.RecomendacionDB(  # Assuming models.RecomendacionDB is your SQLAlchemy model
        uid=recomendaciones.uid,
        iid=recomendaciones.iid,
        r_ui=recomendaciones.r_ui,
        est=recomendaciones.est,
        details=str(recomendaciones.details)  # Make sure to convert complex types to strings or appropriate types
    )
    ...
    # Convert back to Pydantic model if needed for the response
    return models.Recomendacion(
        ...
        details=db_recomendation.details
    )
