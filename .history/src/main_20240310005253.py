...
def obtener_recomendaciones(user_id: str, item_id: str, rating:floats, db: Session = Depends(get_db)):
    recomendaciones = generar_recomendaciones(user_id, item_id, 'Bad Ischl', 1.0)
