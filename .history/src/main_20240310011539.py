...
@app.post("/recomendaciones/{user_id}", response_model=models.Recomendacion)
...
def get_user(db: Session = Depends(get_db)):
    users = db.query(models.UserDB).all()  # Here, ensure you're referencing the correct SQLAlchemy model
    return users
